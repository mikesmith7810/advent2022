package com.mike.day4.part2.application;

import java.util.List;
import java.util.Map;
import java.util.stream.Collectors;

import com.mike.day4.part2.application.calculator.Calculator;
import com.mike.day4.part2.application.parser.InputParser;
