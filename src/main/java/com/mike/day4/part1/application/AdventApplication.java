package com.mike.day4.part1.application;

import java.util.List;
import java.util.Map;
import java.util.stream.Collectors;

import com.mike.day4.part1.application.calculator.Calculator;
import com.mike.day4.part1.application.parser.InputParser;
